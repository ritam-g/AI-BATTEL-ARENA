...
const judgementNode: GraphNode<typeof State> = async (State) => {
    ...
    const agent = createAgent({
        ...
        and then provide the solution with the highest score as the winner and winner name will be "mistral" or "cohere".`,
    })
    ...
    const { solution_1_score, solution_2_score, solution_1_reasoning, solution_2_reasoning, winner } = judgementResponse.structuredResponse
